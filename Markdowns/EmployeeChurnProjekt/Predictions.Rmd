...
while (i < length(threshold_input_rdf)+1) {
    costs_rdf[[(length(costs_rdf) +1)]] <- cost(raw_testH2O_asdf_rdf$prob, 
                                        raw_testH2O_asdf_rdf$EmployeeChurned, 
...
raw_testH2O_asdf_rdf$predict_opti <-classify(raw_testH2O_asdf_rdf$prob, threshold_drf_opti)

confusionMatrix(factor(raw_testH2O_asdf_rdf$predict_opti), factor(raw_testH2O_asdf_rdf$EmployeeChurned),
                positive = "1")
