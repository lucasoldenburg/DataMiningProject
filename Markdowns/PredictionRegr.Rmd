...
glm_params <- list( alpha = c(0.01, 0.25, 0.5, 0.75, 1),
                    ...
                    # standardize = c(TRUE, FALSE) "highly recommended"
                    )
...
```
Die grüne Linie zeigt den selbst geschätzten bzw. gesehenen Treshold am Ellenbogenpunkt. Die rote Line zeigt den berechneten Treshold.
