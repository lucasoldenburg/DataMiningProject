...
predictors_drf <- c("decrease_Category",
                ...
                "Paybands",
                "Nationality_Classification")
# alle Features, da H2O durch das setzen von alpha = 1 automatisch die besten Features auswählt
predictors <- c("Gender",
                "Part Time Mark",
                "TemporaryPersonel",
                "development to exempt",
...
raw_testH2O_asdf$predict <- classify(testH2O_asdf$prob, threshold_glm)
